...
本书像《设计模式》一样,用一个真实项目(Halo,30 万行 TypeScript,开源 AI Agent 平台)作为贯穿全书的案例,讲 AI Agent 系统从引擎到调度到浏览器自动化的设计思想。每一节从一个具体问题开始——"你的应用要跑三个平台怎么办""两个人同时改数据库版本号撞了怎么办"——引出设计原则,再用真实代码验证。

你读完能拿走的不是"Halo 的代码怎么写的",而是"我的项目遇到类似问题时该怎么想"。
